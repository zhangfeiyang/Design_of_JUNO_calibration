...
The Compton effect is due to energy loss in non-LS material, and this will introduce Compton shoulder in PE spectrum. And the Compton shoulder will shift the mean value. Even we use the special function to correct this effect, there is still some uncertainty we should consider. Fig.~\ref{compton} the uncertain due to the Compton effect.
...
\bibitem{lab3}F. P. An et al. 2014 2014 Phys. Rev. Lett. 112, 061801
